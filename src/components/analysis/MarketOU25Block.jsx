// src/components/analysis/MarketOU25Block.jsx
import React from "react";
import { addToHotlist } from "../../utils/hotlistHelper";

export default function MarketOU25Block({ block, fixture }) {
  ...
  // =====================================================
  // HOTLIST — FT IDENTICAL LOGIC (LOCKED)
  // =====================================================
  ...
  return (
    ...
    >
      ...
      <div style={{ marginBottom: 14 }}>
        <div style={{ fontSize: 13, opacity: 0.8 }}>UNDER 2.5</div>
      ...
      {/* OVER */}
      <div>
        <div style={{ fontSize: 13, opacity: 0.8 }}>OVER 2.5</div>
        <div style={{ fontSize: 18, fontWeight: 700 }}>
